...
<div class="tml tml-lostpassword" id="theme-my-login<?php $template->the_instance(); ?>">
    ...
    <p class="message">Veuillez saisir votre adresse de messagerie.<br />Un lien permettant de cr&eacute;er un nouveau mot de passe vous sera envoy&eacute; par e-mail.</p>
