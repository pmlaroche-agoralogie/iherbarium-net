...
<div class="tml tml-register" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form name="registerform" id="registerform<?php $template->the_instance(); ?>" action="<?php $template->the_action_url( 'register', 'login_post' ); ?>" method="post">
        ...
        <p>
            <label for="display_name<?php $template->the_instance(); ?>"><?php _e( 'Nom &agrave; afficher', 'theme-my-login' ) ?></label>
            <input type="text" name="display_name" id="display_name<?php $template->the_instance(); ?>" class="input" value="<?php $template->the_posted_value( 'display_name' ); ?>" size="20" tabindex="20" />
            <input type="hidden" name="user_login" id="user_login"  value="<?php echo getUUID(); ?>" />
        </p>
